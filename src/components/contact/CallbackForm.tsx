...
export function CallbackForm() {
  ...
  if (sent) {
    return (
      <div className="form-done" role="status">
        ...
        <p>Your entries passed the form checks. Nothing was sent, and no call back has been requested.</p>
        <p className="form-note">The practice’s enquiry inbox must be connected before this form goes live.</p>
      </div>
    );
  }
  ...
  return (
    <form ref={form} noValidate onSubmit={onSubmit}>
      ...
      <p className="form-note">Design preview: this form does not send or save your details.</p>
    </form>
  );
}
