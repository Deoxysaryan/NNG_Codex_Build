      ...
      <div className="section-wrap">
        ...
        <div className="footer-bottom">
          ...
          <div className="social-links">
            <a className="social-profile-link" href={site.social.instagram} target="_blank" rel="noopener noreferrer">
              <SocialLogo platform="instagram" /> Instagram ↗
            </a>
            <a className="social-profile-link" href={site.social.youtube} target="_blank" rel="noopener noreferrer">
              <SocialLogo platform="youtube" /> YouTube ↗
            </a>
